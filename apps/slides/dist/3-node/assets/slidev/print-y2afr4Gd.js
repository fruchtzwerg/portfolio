import{d,a0 as u,y as h,b as a,e as t,x as s,A as r,F as f,_ as v,o as n,a1 as g,l as x,g as b}from"../modules/vue-D8tilZHj.js";import{u as y,h as N,c as m,b as k}from"../index-DTWqVGQi.js";import{N as w}from"./NoteDisplay-CVfJ6sTR.js";import"../modules/shiki-DWUOYu4G.js";const L={id:"page-root"},T={class:"m-4"},V={class:"mb-10"},B={class:"text-4xl font-bold mt-2"},D={class:"opacity-50"},H={class:"text-lg"},S={class:"font-bold flex gap-2"},A={class:"opacity-50"},C=t("div",{class:"flex-auto"},null,-1),F={key:0,class:"border-main mb-8"},M=d({__name:"print",setup(j){const{slides:p,total:_}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
