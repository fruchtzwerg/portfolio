import{d,a1 as u,z as h,b as a,e as t,x as s,B as r,F as f,$ as v,o as n,a2 as g,l as x,g as b}from"../modules/vue-DV57PELF.js";import{u as N,h as y,c as m,b as k}from"../index-C1sIx8J3.js";import{N as w}from"./NoteDisplay-A_JorV87.js";import"../modules/shiki-CZ4AHYQn.js";const B={id:"page-root"},L={class:"m-4"},T={class:"mb-10"},V={class:"text-4xl font-bold mt-2"},D={class:"opacity-50"},H={class:"text-lg"},S={class:"font-bold flex gap-2"},z={class:"opacity-50"},C=t("div",{class:"flex-auto"},null,-1),F={key:0,class:"border-main mb-8"},M=d({__name:"print",setup($){const{slides:p,total:_}=N();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
